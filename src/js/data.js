export const quizes = [
  ...
  },
  {
    ...
    description:
      "Go beyond basic types into generics, conditional types, mapped types, template literal types, and utility types. For developers ready to master TypeScript's powerful type system.",
    difficulty: "hard",
    questionCount: 10,
  },
  {
  ...
  },
  {
    ...
    description:
      "Prepare for DevOps interviews with essential Docker questions covering containers, images, volumes, networking, and orchestration. Covers Docker fundamentals through advanced topics.",
    difficulty: "medium",
    questionCount: 10,
  },
  {
